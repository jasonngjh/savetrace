...
class DoctorSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        // if (($handle = fopen("/Users/jasonng/Desktop/drive-download-20210218T053958Z-001/practiceplaces.csv", "r")) !== FALSE) {
        ...
        // if (($handle = fopen("/Users/jasonng/Desktop/drive-download-20210218T053958Z-001/nurses.csv", "r")) !== FALSE) {
        //     while (($data = fgetcsv($handle, 1000, ",")) !== FALSE) {
        //         $nurses_data[] = $data;
        //     }
        //     fclose($handle);
        ...
        // if (($handle = fopen("/Users/jasonng/Desktop/drive-download-20210218T053958Z-001/doctors.csv", "r")) !== FALSE) {
        //     while (($data = fgetcsv($handle, 1000, ",")) !== FALSE) {
        //         $doctors_data[] = $data;
        //     }
        //     fclose($handle);
        ...
        // if (($handle = fopen("/Users/jasonng/Desktop/drive-download-20210218T053958Z-001/users.csv", "r")) !== FALSE) {
        //     while (($data = fgetcsv($handle, 1000, ",")) !== FALSE) {
        //         $users_data[] = $data;
        //     }
        //     fclose($handle);
