                ...
                <table class="border-collapse table-auto w-full whitespace-no-wrap bg-white table-striped relative">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="border-dashed border-t border-gray-200">
                                <div class="flex">
                                    @if($user->roles->first()->name === 'SystemAdmin')
                                    ...
                                    @elseif($user->roles->first()->name === 'nurse')
                                ...
                                <div class="flex">
                                    <form method="GET" action="{{ route('users.edit') }}">
                                        ...
                                        <button class="flex items-center">
                                            <svg xmlns="https://www.w3.org/2000/svg" class="w-6 text-gray-500" viewBox="0 0 20 20" fill="currentColor">
