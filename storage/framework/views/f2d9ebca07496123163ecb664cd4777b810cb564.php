...
<?php endif; ?> 
                    <div class="relative rounded-md shadow-sm">
                        <input type="hidden" name="date" x-ref="date">
                         <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'jetstream::components.input','data' => ['type' => 'text','id' => 'dob','name' => 'dob','value' => old('dob'),'required' => true,'readonly' => true,'xModel' => 'datepickerValue','@click' => 'showDatepicker = !showDatepicker','@keydown.escape' => 'showDatepicker = false','class' => 'w-full pl-4 pr-10 py-3 leading-none rounded-md shadow-sm focus:outline-none focus:shadow-outline text-gray-600','placeholder' => 'Select Date of Birth']]); ?>
<?php $component->withName('jet-input'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['type' => 'text','id' => 'dob','name' => 'dob','value' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(old('dob')),'required' => true,'readonly' => true,'x-model' => 'datepickerValue','@click' => 'showDatepicker = !showDatepicker','@keydown.escape' => 'showDatepicker = false','class' => 'w-full pl-4 pr-10 py-3 leading-none rounded-md shadow-sm focus:outline-none focus:shadow-outline text-gray-600','placeholder' => 'Select Date of Birth']); ?>
<?php if (isset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4)): ?>
<?php $component = $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4; ?>
<?php unset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4); ?>
<?php endif; ?>
