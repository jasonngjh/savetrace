        ...
        <div class="bg-white shadow-lg rounded-lg w-full my-4">
            <div class="py-2 px-8">
                ...
                <h2 class="font-normal text-xl text-gray-800 leading-tight">
                    <?php echo e($curr_date . " " . $curr_time); ?>
...
<?php endif; ?> 
                ...
                <div class="flex justify-end">
                    <?php if($dateSelected or $timeSelected): ?>
                    <div>
...
<?php $component->withAttributes(['wire:model' => 'confirmingSubmit']); ?>
                             ...
                             <?php $__env->slot('footer'); ?> 
                                 <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'jetstream::components.button','data' => ['class' => 'ml-2','wire:click' => 'changeAppt','wire:loading.attr' => 'disabled']]); ?>
<?php $component->withName('jet-button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['class' => 'ml-2','wire:click' => 'changeAppt','wire:loading.attr' => 'disabled']); ?>
                                    <?php echo e(__('Change Appointment')); ?>
...
<?php endif; ?> 
    ...
    </script><?php /**PATH /Users/jasonng/Desktop/SaveTrace/resources/views/livewire/patients/change-appointment-form.blade.php ENDPATH**/ ?>