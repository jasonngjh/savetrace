...
<?php endif; ?> 
            ...
            <div class="flex justify-right">
                ...
                <div class="flex-shrink-0 flex items-center">
                    ...
                    <a href="<?php echo e(route('all.search')); ?>" class="text-grey-800 px-2 py-2 rounded-lg hover:bg-blue-100">
                        Find A Doctor
                    </a>
                    <?php endif; ?>
                </div>
...
<?php endif; ?> 
                ...
                <?php endif; ?>
                <?php if(auth()->guard()->guest()): ?>
                <a href="<?php echo e(route('/')); ?>" class="flex items-center ml-6">
                    <span>Login</span>
                </a>
                <?php endif; ?>
            </div>
...
</nav><?php /**PATH /Users/jasonng/Desktop/SaveTrace/resources/views/navigation-dropdown.blade.php ENDPATH**/ ?>